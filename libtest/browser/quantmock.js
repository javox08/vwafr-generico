...
(function(){
  ...
  window.fetch=function(u){u=''+u;
    try{
      if(u.indexOf('/api/social')>=0)return J({t:Date.now(),tiktok:{f:531,v:782,likes:10400},youtube:{subs:'34 subscribers'},twitch:{live:true},x:{f:24},fb1:{name:'Notici Javox'},fb2:{name:'NotiExpress',n:'3 me gusta'}});
